...
function timer (date) {
  ...
  if (timeLeft < 0) {
    ...
    link.innerHTML = `PLEASE CLICK THE LINK TO START MEETING: ` + '<br></br>' + `<a href="http://localhost:3000/appointment/${data.Id}" style="color: blue">http://localhost:3000/appointment/${data.Id}</a>`;
